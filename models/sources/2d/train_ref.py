...
callbacks = [EarlyStopping(monitor='val_reconstruction_loss',patience=500,restore_best_weights=True),
            ModelCheckpoint(filepath=file_check+'.hdf5',monitor='val_loss',save_best_only=True),
            CSVLogger('training{}.log'.format(i_seed),append=True)]
